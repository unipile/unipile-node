...
class HeyApiRegistry12<T> {
    ...
    get(key?: string): T {
        const instance = this.instances.get(key ?? this.defaultKey);
        if (!instance) {
            throw new Error(`No SDK client found. Create one with "new UnipileApiKeys()" to fix this error.`);
        }
        return instance;
    }
...
class HeyApiRegistry13<T> {
    ...
    get(key?: string): T {
        const instance = this.instances.get(key ?? this.defaultKey);
        if (!instance) {
            throw new Error(`No SDK client found. Create one with "new UnipileScopes()" to fix this error.`);
        }
        return instance;
    }
...
export class UnipileMessaging extends HeyApiClient {
     ...
     */
    public deleteChat<ThrowOnError extends boolean = false>(options: Options<DeleteChatData, ThrowOnError>) {
        return (options.client ?? this.client).delete<DeleteChatResponses, unknown, ThrowOnError>({
            security: [{ name: 'X-API-KEY', type: 'apiKey' }],
     ...
     */
    public getUserChat<ThrowOnError extends boolean = false>(options: Options<GetUserChatData, ThrowOnError>) {
        return (options.client ?? this.client).get<GetUserChatResponses, unknown, ThrowOnError>({
            security: [{ name: 'X-API-KEY', type: 'apiKey' }],
...
export class UnipilePosts extends HeyApiClient {
     ...
     */
    public createStory<ThrowOnError extends boolean = false>(options: Options<CreateStoryData, ThrowOnError>) {
        return (options.client ?? this.client).post<CreateStoryResponses, unknown, ThrowOnError>({
            security: [{ name: 'X-API-KEY', type: 'apiKey' }],
     ...
     */
    public getUserCommentsList<ThrowOnError extends boolean = false>(options: Options<GetUserCommentsListData, ThrowOnError>) {
        return (options.client ?? this.client).get<GetUserCommentsListResponses, unknown, ThrowOnError>({
            security: [{ name: 'X-API-KEY', type: 'apiKey' }],
     ...
     */
    public getUserReactionsList<ThrowOnError extends boolean = false>(options: Options<GetUserReactionsListData, ThrowOnError>) {
        return (options.client ?? this.client).get<GetUserReactionsListResponses, unknown, ThrowOnError>({
            security: [{ name: 'X-API-KEY', type: 'apiKey' }],
...
export class UnipileCalendar extends HeyApiClient {
     ...
     */
    public setCalendarEventRsvp<ThrowOnError extends boolean = false>(options: Options<SetCalendarEventRsvpData, ThrowOnError>) {
        return (options.client ?? this.client).post<SetCalendarEventRsvpResponses, unknown, ThrowOnError>({
            security: [{ name: 'X-API-KEY', type: 'apiKey' }],
     ...
     */
    public cancelCalendarEvent<ThrowOnError extends boolean = false>(options: Options<CancelCalendarEventData, ThrowOnError>) {
        return (options.client ?? this.client).post<CancelCalendarEventResponses, unknown, ThrowOnError>({
            security: [{ name: 'X-API-KEY', type: 'apiKey' }],
     ...
     */
    public restoreCalendarEvent<ThrowOnError extends boolean = false>(options: Options<RestoreCalendarEventData, ThrowOnError>) {
        return (options.client ?? this.client).post<RestoreCalendarEventResponses, unknown, ThrowOnError>({
            security: [{ name: 'X-API-KEY', type: 'apiKey' }],
...
export class UnipileLinkedIn extends HeyApiClient {
     ...
     */
    public getAvailableContracts<ThrowOnError extends boolean = false>(options: Options<GetAvailableContractsData, ThrowOnError>) {
        return (options.client ?? this.client).get<GetAvailableContractsResponses, unknown, ThrowOnError>({
            security: [{ name: 'X-API-KEY', type: 'apiKey' }],
     ...
     */
    public selectContract<ThrowOnError extends boolean = false>(options: Options<SelectContractData, ThrowOnError>) {
        return (options.client ?? this.client).post<SelectContractResponses, unknown, ThrowOnError>({
            security: [{ name: 'X-API-KEY', type: 'apiKey' }],
...
export class UnipileCustomAuth extends HeyApiClient {
     ...
     */
    public requestCheckpoint<ThrowOnError extends boolean = false>(options: Options<RequestCheckpointData, ThrowOnError>) {
        return (options.client ?? this.client).post<RequestCheckpointResponses, unknown, ThrowOnError>({
            security: [{ name: 'X-API-KEY', type: 'apiKey' }],
            url: '/v2/auth/checkpoint/request',
            ...options,
            headers: {
                'Content-Type': 'application/json',
                ...options.headers
...
export class UnipileApiKeys extends HeyApiClient {
    public static readonly __registry = new HeyApiRegistry12<UnipileApiKeys>();
    ...
    constructor(args?: {
        ...
        super(args);
        UnipileApiKeys.__registry.set(this, args?.key);
    }
     ...
     */
    public listApiKeys<ThrowOnError extends boolean = false>(options?: Options<ListApiKeysData, ThrowOnError>) {
        return (options?.client ?? this.client).get<ListApiKeysResponses, unknown, ThrowOnError>({
            security: [{ name: 'X-API-KEY', type: 'apiKey' }],
            url: '/v2/api-keys/',
            ...options
        });
     ...
     */
    public createApiKey<ThrowOnError extends boolean = false>(options?: Options<CreateApiKeyData, ThrowOnError>) {
        return (options?.client ?? this.client).post<CreateApiKeyResponses, unknown, ThrowOnError>({
            security: [{ name: 'X-API-KEY', type: 'apiKey' }],
            url: '/v2/api-keys/',
            ...options,
            headers: {
     ...
     */
    public deleteApiKey<ThrowOnError extends boolean = false>(options: Options<DeleteApiKeyData, ThrowOnError>) {
        return (options.client ?? this.client).delete<DeleteApiKeyResponses, unknown, ThrowOnError>({
            security: [{ name: 'X-API-KEY', type: 'apiKey' }],
...
export class UnipileScopes extends HeyApiClient {
    public static readonly __registry = new HeyApiRegistry13<UnipileScopes>();
    ...
    constructor(args?: {
        ...
        super(args);
        UnipileScopes.__registry.set(this, args?.key);
    }
     ...
     */
    public listScopes<ThrowOnError extends boolean = false>(options?: Options<ListScopesData, ThrowOnError>) {
        return (options?.client ?? this.client).get<ListScopesResponses, unknown, ThrowOnError>({
            security: [{ name: 'X-API-KEY', type: 'apiKey' }],
            url: '/v2/scopes/',
            ...options
        });
     ...
     */
    public createScope<ThrowOnError extends boolean = false>(options: Options<CreateScopeData, ThrowOnError>) {
        return (options.client ?? this.client).post<CreateScopeResponses, unknown, ThrowOnError>({
            security: [{ name: 'X-API-KEY', type: 'apiKey' }],
            url: '/v2/scopes/',
            ...options,
            headers: {
     ...
     */
    public deleteScope<ThrowOnError extends boolean = false>(options: Options<DeleteScopeData, ThrowOnError>) {
        return (options.client ?? this.client).delete<DeleteScopeResponses, unknown, ThrowOnError>({
            security: [{ name: 'X-API-KEY', type: 'apiKey' }],
     ...
     */
    public getScope<ThrowOnError extends boolean = false>(options: Options<GetScopeData, ThrowOnError>) {
        return (options.client ?? this.client).get<GetScopeResponses, unknown, ThrowOnError>({
            security: [{ name: 'X-API-KEY', type: 'apiKey' }],
            url: '/v2/scopes/{scope_id}',
            ...options
        });
     ...
     */
    public updateScope<ThrowOnError extends boolean = false>(options: Options<UpdateScopeData, ThrowOnError>) {
        return (options.client ?? this.client).patch<UpdateScopeResponses, unknown, ThrowOnError>({
            security: [{ name: 'X-API-KEY', type: 'apiKey' }],
            url: '/v2/scopes/{scope_id}',
            ...options,
            headers: {
...
export class UnipileWebhooks extends HeyApiClient {
    public static readonly __registry = new HeyApiRegistry14<UnipileWebhooks>();
